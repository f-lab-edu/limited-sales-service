...
public class UserService {
  ...
  */
  ...
  public void saveUser(final User user) {
    if (!userMapper.emailExists(user.getUserEmail())) {
      User joinUser =
          User.builder()
  ...
  public boolean emailExists(String userEmail) {
    return userMapper.emailExists(userEmail);
  }
  ...
  public void logout(String userEmail, String accessToken) {
    ...
    redisService.setValue(
        JwtProperties.BLACKLIST_TOKEN_PREFIX + accessToken.replace(JwtProperties.TOKEN_PREFIX, ""),
        userEmail,
